...
namespace ft {
	...
	public:
		...
		bool operator==(const const_bst_iterator<T,U>& rhs) const { return (_elem == rhs.base()); }
	...
	public:
		...
		bool operator==(const const_bst_iterator& rhs) const { return (_elem == rhs.base()); }

		bool operator!=(const const_bst_iterator& rhs) const { return (_elem != rhs.base()); }

		bool operator==(const bst_iterator<T,U>& rhs) { return (_elem == rhs.base()); }
